...
My next task is to learn how to do Data Fetching with Hooks / Replacing Class Lifecycle Methods (useEffect, useRef). The repo to that learning process can be found [here](#).
